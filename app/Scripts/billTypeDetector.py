...
if __name__ == "__main__":
    ...
    try:
        ...
        input_file = data_path + "/original.jpg"
        ...
        if is_has_logo:
            status.write("[complete]|success|bhx")
        else:
            status.write("[complete]|success|unsupported")
    except Exception as e:
        status.write("[complete]|error|" + str(e))
    status.close()
    ...
    #     if label == "logo":            
    #         f = open(data_path + "/bill-type.txt", "w")
    #         f.write("bhx")
    #         f.close()
